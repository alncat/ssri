...
void initialise_model_optimizer(int, int, int, int, float, int);
int train_a_batch(std::vector<float> &data, int part_id);
int train_unet(std::vector<float> &data, std::vector<float>& target, std::vector<float>& weight, int part_id);
